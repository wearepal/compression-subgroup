...
class BertLMPredictionHead(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        hidden_states = self.dequant(self.decoder(self.quant(hidden_states)))
        return hidden_states
...
class BertOnlyNSPHead(nn.Module):
    ...
    def forward(self, pooled_output):
        seq_relationship_score = self.dequant(self.seq_relationship(self.quant(pooled_output)))
...
class BertForTokenClassification(BertPreTrainedModel):
    ...
    def forward(
        ...
        logits = self.dequant(self.classifier(self.quant(sequence_output)))
...
class BertForQuestionAnswering(BertPreTrainedModel):
    ...
    def forward(
        ...
        logits = self.dequant(self.qa_outputs(self.quant(sequence_output)))
