...
def main():
    ...
    for i, data in enumerate(['multinli', 'jigsaw', 'scotus']):
    ...
    plt.savefig(os.path.join('..', 'figures', 'accuracy.pdf'), bbox_inches='tight')
    print(os.path.exists(os.path.join('..', 'figures', 'accuracy.pdf')))
